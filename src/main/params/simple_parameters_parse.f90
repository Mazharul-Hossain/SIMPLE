...
contains
    ...
    module subroutine bind_input_carg(self, reg)
        ...
        call reg%add_char('sgd_assignment_only', self%sgd_assignment_only)
        call reg%add_char('sgd_diag', self%sgd_diag)
    ...
    module subroutine bind_input_rarg(self, reg)
        ...
        call reg%add_real('sgd_cavg_max_rel_step', self%sgd_cavg_max_rel_step)
        call reg%add_real('sgd_cavg_min_support', self%sgd_cavg_min_support)
